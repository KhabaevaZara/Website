document.addEventListener('DOMContentLoaded', async () => {
    const wrapper = document.getElementById('swiper-wrapper3');
    ...
    function addToCart(button) {
        ...
        const quantity = button.closest('.Buttons').querySelector('.js-number').value;
        
        console.log(`Добавлено в корзину: ${title} (ID: ${id}), цена: ${price}, количество: ${quantity}`);
